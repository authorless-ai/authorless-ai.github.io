...
faq:
  - q: "How do I prevent unauthorised content from being published?"
    a:
      - "Role-based permissions and approval workflows. In Bazam, only editors and admins can publish. Contributors create and submit — content must be approved before scheduling. The permission system enforces governance by design."

  - q: "How do I create an audit trail for published content?"
    a:
      - "Bazam tracks who created each piece, who reviewed it, who approved it, and when it was published. For regulated industries or compliance requirements, the complete content history is available for auditing."
  ...
  - q: "How do I control what AI can and cannot say in content?"
    a:
      - "Brand voice settings include negative instructions — things to avoid, tones to never use, claims to never make. Bazam respects these boundaries. Combined with human approval, content stays within defined limits."

  - q: "How do I recover from a content mistake?"
    a:
      - "Identify the published mistake, create a corrected version, and republish immediately. Use Bazam's audit trail to understand what went wrong — where in the process the error slipped through. Update the workflow to prevent recurrence."
  ...
  - q: "How do I set up content governance for a growing team?"
    a:
      - "Define roles, configure approval workflows, and set brand guardrails before the team grows. Bazam scales governance with the team — new members inherit the existing structure. Governance is established once and maintained automatically."
---
