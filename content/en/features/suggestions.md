...
heroDescription: Say goodbye to writer's block. Bazam AI Suggestions provide endless inspiration to fuel your content strategy.
...
- title: "End Writer's Block: Generate Infinite Content Ideas"
  ...
  description:
    - Staring at a blank page? Bazam banishes writer's block with a constant stream of relevant and engaging suggestions.
  ...
  points:
    - title: Overcome Writer's Block
      description: Never run out of ideas with Bazam's AI-powered content suggestions.
...
- title: "Relevant Content for Your Audience"
  ...
  description:
    - Stop guessing what your audience wants to see. Bazam analyses your business, products, and target market to deliver hyper-relevant content suggestions.
  points:
    - title: Target Your Ideal Customer
      description: Focus your content on the topics most relevant to your target audience, powered by Bazam.
