...
testimonials:
  ...
  cards:
    - title: Our conversion rates shot up instantly
      quote: "We moved from targeting broad 'marketing managers' to hyper-focused profiles based on decision-making styles. The impact on our demo requests and bottom line was immediate. We're finally speaking the language of our best customers."
      avatar: "https://i.pravatar.cc/150?u=maria_rodriguez"
      name: "Maria Rodriguez"
      role: "VP of Demand Generation"
    - title: We turned our ad spend into a revenue machine
      quote: "Before, we were wasting money targeting the whole industry. Now, we know the exact behavioral triggers that convert. Our cost-per-lead is down 60%, and our marketing is a predictable driver of sales. It's a game-changer."
      avatar: "https://i.pravatar.cc/150?u=kevin_omalley"
      name: "Kevin O'Malley"
      role: "Chief Marketing Officer"
    - title: My campaigns are now the top performers
      quote: "The AI generates dozens of email variations tailored to our different persona segments, but I still approve everything before it goes live. What used to take me days now takes hours, and the performance data helps me pick the winners every time."
