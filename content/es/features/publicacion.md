...
heroDescription: Llega a tu audiencia dondequiera que esté. Bazam publica directamente en las plataformas, simplificando la distribución de tu contenido.
...
- title: "Publicación directa: distribución sin esfuerzo"
  ...
  description:
    - Deja de perder tiempo subiendo manualmente contenido a múltiples plataformas. Bazam publica directamente en tu blog y canales de redes sociales.
  ...
  footer:
    - Publica más rápido, llega más lejos. Bazam facilita la distribución de contenido.
- title: "Plataformas integradas: conecta tu mundo"
  ...
  points:
    ...
    - title: Fácil integración de cuentas
      description: Conecta rápida y fácilmente tus cuentas a Bazam.
