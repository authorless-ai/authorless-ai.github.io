...
features:
  - title: "Una puntuación no explica por qué compran"
    ...
    points:
      ...
      - { title: "Bazam lo reescribe todo para que encaje", description: "Elige la emoción y todas las publicaciones de ese mes se escribirán de ese modo." }
    footer:
  ...
  - title: "Trabaja para tus clientes"
    ...
    image_alt: "Aprobación del cliente y acceso basado en roles en Bazam"
    description:
      - "La redacción nunca fue la parte incómoda. Lo eran los inicios de sesión y perseguir las aprobaciones."
    points:
      - { title: "Cada cliente conserva su acceso", description: "Conecta sus propios canales. Tú nunca gestionas su contraseña." }
      - { title: "Nada se publica sin un sí", description: "Los clientes aprueban sus publicaciones en su propio portal." }
      - { title: "Un proyecto por cliente", description: "Perfiles, voz de marca y conocimiento separados. Nada se mezcla." }
    footer:
...
faq:
  ...
  - q: "¿Publica por mí?"
    a:
      - "Sí: en Facebook, Instagram, TikTok, X, LinkedIn y WordPress, con una versión adaptada a cada canal y el calendario que defines una vez."
  - q: "¿Puedo saber qué ha funcionado?"
    a:
      - "Sí. Bazam reúne las métricas de todos los canales y las agrupa por campaña para mostrarte qué campañas merecieron la pena."
  - q: "Vendo en más de un país."
    a:
      - "Una campaña se publica en más de 50 idiomas manteniendo tu voz de marca. La escribes una vez y la publicas en todos tus mercados."
